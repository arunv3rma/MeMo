...
OUTPUT_DIR=./NQA_valid-split_datagen_step1_5_hipporag10
mkdir -p ${OUTPUT_DIR}
LOG_DIR=./logs/step1_5_qwen32b_nqa
mkdir -p ${LOG_DIR}
...
COMBINE_DIRECT_AND_INDIRECT_EXPR_PREFIX="NQA_chunks_subset${MAX_NUM_DOCS}_numsamplingepochs${NUM_SAMPLING_EPOCHS}_combine_direct_and_indirect_extraction_cache"
...
PERMUTATION_CONSOLIDATION_EXPR_PREFIX="NQA_chunks_subset${MAX_NUM_DOCS}_numsamplingepochs${NUM_SAMPLING_EPOCHS}_permutation_consolidation_extraction_cache"
...
SELF_CONTAINMENT_VERIFICATION_EXPR_PREFIX="NQA_chunks_subset${MAX_NUM_DOCS}_numsamplingepochs${NUM_SAMPLING_EPOCHS}_post_permutation_consolidation_verified_extraction_cache"
...
CROSSDOC_COMBO_EXPR_PREFIX="NQA_chunks_subset${MAX_NUM_DOCS}_numsamplingepochs${NUM_SAMPLING_EPOCHS}_crossdoc_entity_combination"

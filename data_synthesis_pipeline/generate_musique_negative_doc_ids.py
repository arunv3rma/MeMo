...
def generate_n(qns_path, output_path, seed):
    ...
    print(f"Written {len(negative_doc_ids_per_query)} query entries (N) to {output_path}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--qns_path', default='/path/to/musique_questions_chunks_1000.jsonl')
    parser.add_argument('--output_path', default=os.path.join(_default_dir, 'musique_negative_N_doc_ids_per_query.json'))
    parser.add_argument('--output_path_2n', default=os.path.join(_default_dir, 'musique_negative_2N_doc_ids_per_query.json'))

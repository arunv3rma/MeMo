#!/usr/bin/env bash
# bcp_LOO_data_ablation.sh
#
# Full BCP with-negatives data generation pipeline (steps 1a–5) with one step ablated.
...
#
# Usage:
#   ./bcp_LOO_data_ablation.sh <ABLATE_STEP>
#
...
#
# Examples:
#   ./bcp_LOO_data_ablation.sh 2      # skip consolidation
#   ./bcp_LOO_data_ablation.sh 5      # skip cross-doc combination
#   ./bcp_LOO_data_ablation.sh none   # run everything
...
OUTPUT_DIR=./ablation_with_neg_bcp${MAX_NUM_QUESTIONS}_skip_step${ABLATE_STEP}
LOG_DIR=./logs/ablation_with_neg_bcp_skip_step${ABLATE_STEP}
mkdir -p ${OUTPUT_DIR}
mkdir -p ${LOG_DIR}

echo "=========================================================="
echo " BCP with-negatives Ablation Pipeline"
...
COMBINE_EXPR_PREFIX="bcp_subset${MAX_NUM_QUESTIONS}_numsamplingepochs${NUM_SAMPLING_EPOCHS}_combine_direct_and_indirect_extraction_cache"
...
CONSOLIDATION_EXPR_PREFIX="bcp_subset${MAX_NUM_QUESTIONS}_numsamplingepochs${NUM_SAMPLING_EPOCHS}_permutation_consolidation_extraction_cache"
...
SELF_CONTAINMENT_EXPR_PREFIX="bcp_subset${MAX_NUM_QUESTIONS}_numsamplingepochs${NUM_SAMPLING_EPOCHS}_post_permutation_consolidation_verified_extraction_cache"
...
CROSSDOC_EXPR_PREFIX="bcp_subset${MAX_NUM_QUESTIONS}_numsamplingepochs${NUM_SAMPLING_EPOCHS}_crossdoc_entity_combination"

"""
Naive multi-turn extension of eval_bcp_trng.py (single-turn).
...
async def main():
    ...
    summary_output = {
        "summary": {
            ...
            "overall_accuracy": sum(1 for item in eval_output if item.get('score', 0.0) == 1.0) / len(eval_output)
        },

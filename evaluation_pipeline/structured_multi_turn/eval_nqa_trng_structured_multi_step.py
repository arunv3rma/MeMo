...
from nqa_data_utils import SUBSET_MAP, load_questions_with_evidence_docs_nqa
...
async def main():
    ...
    parser.add_argument("--max_num_docs", type=int, default=None, help="Limit to questions from the first N unique source documents")
    ...
    data_pairs = [
        {
            ...
            'ans2': item['groundtruth']  # list of reference answers
        }
        for item in output
    ]

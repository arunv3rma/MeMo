...
export CARTRIDGES_DIR=<your-cartridges-checkout>

# path to a directory where you want to store outputs like models checkpoints and such
export CARTRIDGES_OUTPUT_DIR=<your-cartridges-outputs-dir>
...
```bash
>>> Final output saved to <output-dir>/artifact/dataset.parquet
```

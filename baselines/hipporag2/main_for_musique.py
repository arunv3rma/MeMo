...
def main():
    parser = argparse.ArgumentParser(description="HippoRAG for MuSiQue with NV-Embed-v2 and vLLM (Async)")
    parser.add_argument("--corpus", type=str, required=True, help="Path to MuSiQue corpus JSONL file")
    parser.add_argument("--questions", type=str, required=True, help="Path to MuSiQue questions JSONL file")
    parser.add_argument("--output", type=str, default="rag_results_hippo_musique.json", help="Path to save output")
    ...
    parser.add_argument("--save_dir", type=str, default=None,
                        help="Directory for HippoRAG index/graph output. If omitted, a timestamped "
                             "dir under ./baselines/hipporag2/output_musique/<corpus_tag>_<ts> is used.")
    ...
    # 1b. Load corpus (only docs referenced by the loaded questions)
    ...
    if args.save_dir is None:
        ...
        save_dir = f"./baselines/hipporag2/output_musique/{corpus_tag}_{timestamp}"
    else:

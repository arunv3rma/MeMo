...
Data preparation, the 10-document subset, and the 293-question count are documented in `baselines/README.md` (the "Data preparation → NarrativeQA" section). This README only covers the evaluation entrypoints.
